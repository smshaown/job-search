...
const Statistics = () => {
  ...
  return (
    <div className="my-container mt-8">
      <h1 className="mb-4 text-2xl md:text-4xl font-bold text-regalBlack text-center ">
      ...
      <h2 className="mb-4 text-2xl md:text-4xl font-bold text-regalBlack text-center ">
